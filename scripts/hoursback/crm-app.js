...
${process.env.CRM_PRODUCT_PREVIEW === "1" ? '<nav aria-label="Products"><a href="/">VisionAIry</a><a href="/products/stockerai">StockerAI</a></nav>' : ""}<nav><a href="/">Today</a><a href="/pipeline">Pipeline</a><a href="/money">Money</a><a href="/progress">Progress</a><a href="/list">VisionAIry companies</a><a href="/people">People</a><a href="/email">Email</a><a href="/linkedin">LinkedIn</a><a href="/needemail">Needs email</a><a href="/add">+ Add</a></nav>${body}</body></html>`;
}
...
async function list(params) {
  ...
  return page(`<h1>${needsALook ? 'VisionAIry businesses that need a look' : showAll ? 'Every VisionAIry business' : 'VisionAIry businesses you can reach'} (${total.toLocaleString()})</h1>
