...
@media(max-width:700px){.workspace{grid-template-columns:1fr}.email-summary{grid-template-columns:auto auto 1fr auto}.email-summary .subject{grid-column:3/5}.email-summary .state{display:none}}
</style></head><body>
<div class="brand">
...
async function emailScreen(params) {
  ...
  <p class="muted">Each campaign has four messages: Day 0, Day 4, Day 8, and Day 14. Open any company to see the recipient, the current message, and the follow-ups in order.</p>
